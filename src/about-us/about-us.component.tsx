const AboutUs = () => {
  return (
    <div>
      ...
      >
        <div className="flex-1 text-3xl mx-5 p-[1em] font-roboto">
          <div className="flex flex-col items-center content-center ">
            <p className="text-base md:text-[20px] lg:text-[30px] mb-3 drop-shadow-[2px_2px_rgba(255,255,255,.5)] text-black">
              Rules & Objectives
            </p>
            <p
              id="rules"
              className="text-base md:text-[20px] lg:text-[30px] mb-5 text-center drop-shadow-[2px_2px_rgba(255,255,255,.5)]"
            >
            ...
            <p className="text-base md:text-[20px] lg:text-[30px] p-5 text-center drop-shadow-[2px_2px_rgba(255,255,255,.5)] text-black">
              The goals of the Sri Lanka Society of Queensland are:
            </p>
          </div>

          <div className="mt-8 text-center">
            <ul className="text-base md:text-[20px] lg:text-[30px] leading1-relaxed sm1:leading-normal text-[#7F1734]">
